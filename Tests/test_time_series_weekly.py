...
class Test_TimeSeriesWeekly(Base.BaseClass):

    @pytest.mark.skipif(Base.is_testcase_runnable('test_time_series_weekly'), reason="skipping because flag is set to false in excel")
    def test_time_series_weekly(self):
        ...
        # symbol validation
        self.assertion.assert_equal(response_json['Meta Data']['2. Symbol'] , "IBM",
                         "Expected symbol is IBM but found "+ response_json['Meta Data']['2. Symbol'])
    ...
    @pytest.mark.skipif(Base.is_testcase_runnable('test_time_series_weekly_invalid_symbol'), reason="skipping because flag is set to false in excel")
    ...
    @pytest.mark.skipif(Base.is_testcase_runnable('test_time_series_weekly_invalid_apiToken_and_symbol'), reason="skipping because flag is set to false in excel")
    ...
    @pytest.mark.skipif(Base.is_testcase_runnable('test_time_series_weekly_without_symbol_parameter'), reason="skipping because flag is set to false in excel")
    ...
    @pytest.mark.skipif(Base.is_testcase_runnable('test_time_series_weekly_without_apikey_parameter'), reason="skipping because flag is set to false in excel")
